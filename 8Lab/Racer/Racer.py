...
game_over = pg.image.load(r"C:\Users\acer\Desktop\pp2\8Lab\Racer\gameover.jpg")
bg = pg.image.load(r"C:\Users\acer\Desktop\pp2\8Lab\Racer\AnimatedStreet.png")
...
class Enemy(pg.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pg.image.load(r"C:\Users\acer\Desktop\pp2\8Lab\Racer\Enemy.png")
...
class Player(pg.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pg.image.load(r"C:\Users\acer\Desktop\pp2\8Lab\Racer\Player.png")
        self.rect = self.image.get_rect()
...
class Coin(pg.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pg.image.load(r"C:\Users\acer\Desktop\pp2\8Lab\Racer\coin.png")
        self.rect = self.image.get_rect()
